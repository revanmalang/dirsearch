...
![Stars](https://img.shields.io/github/stars/revanmalang/dirsearch.svg)
[![Release](https://img.shields.io/github/release/revanmalang/dirsearch.svg)](https://github.com/revanmalang/dirsearch/releases)
[![Sponsors](https://img.shields.io/github/sponsors/revanmalang)](https://github.com/sponsors/revanmalang)
...
**dirsearch** is being actively developed by [@revanmalang](https://twitter.com/_revanmalang) and [@shelld3v](https://twitter.com/shells3c_)

*Reach to our [Discord server](https://discord.gg/dfcFWzKzb6) to communicate with the team at best*
...
- Install with **git**: `git clone https://github.com/revanmalang/dirsearch.git --depth 1` (**RECOMMENDED**)
- Install with ZIP file: [Download here](https://github.com/revanmalang/dirsearch/archive/master.zip)
- Install with Docker: `docker build -t "dirsearch:v0.4.3" .` (more information can be found [here](https://github.com/revanmalang/dirsearch#support-docker))
...
See [CONTRIBUTORS.md](https://github.com/revanmalang/dirsearch/blob/master/CONTRIBUTORS.md) to know who they are.
...
License
---------------
Copyright (C) Mauro Soria (revanmalang584@gmail.com)
